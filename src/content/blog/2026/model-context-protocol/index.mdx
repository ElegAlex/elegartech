...
description: "Le Model Context Protocol (MCP), standard créé par Anthropic et adopté par OpenAI, Google et Microsoft, unifie les connexions entre agents IA et outils externes."
date: 2026-01-02
categories: ["IA"]
tags: ["MCP", "Anthropic", "OpenAI", "agents IA", "Linux Foundation", "interopérabilité", "LLM", "standards"]
author: admin
draft: false
featured: false
---
